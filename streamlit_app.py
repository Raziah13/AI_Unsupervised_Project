# Create streamlit_app.py - Results persist after clicking Run
import os
...
with open('streamlit_app.py', 'w', encoding='utf-8') as f:
    ...
    f.write("        \n")
    f.write("        with col1:\n")
    f.write("            k_value = st.slider('Number of Clusters (k)', 2, 10, 5, key='kmeans_k_slider')\n")
    ...
    f.write("        \n")
    f.write("        # Show results if available\n")
    f.write("        if st.session_state.kmeans_labels is not None:\n")
    ...
    f.write("        \n")
    f.write("        with col1:\n")
    f.write("            eps_value = st.slider('Epsilon (eps)', 0.1, 2.0, 0.8, 0.05, key='dbscan_eps')\n")
    f.write("            min_samples_value = st.slider('Min Samples', 2, 20, 5, key='dbscan_min_samples')\n")
    f.write("            \n")
    ...
    f.write("            ax.set_xlabel('First Principal Component')\n")
    f.write("            ax.set_ylabel('Second Principal Component')\n")
    f.write("            ax.set_title('DBSCAN Clustering Results (eps=' + str(st.session_state.dbscan_eps) + ', min_samples=' + str(st.session_state.dbscan_min_samples) + ')')\n")
    ...
    f.write("            if st.session_state.kmeans_labels is None:\n")
    f.write("                st.info('Go to K-Means Clustering page and click Run K-Means')\n")
    f.write("            if st.session_state.dbscan_labels is None:\n")
