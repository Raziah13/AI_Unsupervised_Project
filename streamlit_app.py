# Create streamlit_app.py - Fixed version
import os
...
with open('streamlit_app.py', 'w', encoding='utf-8') as f:
    ...
    f.write("    \n")
    f.write("    # Initialize session state for cluster column\n")
    ...
    f.write("    if 'df_clean' not in st.session_state:\n")
    f.write("        st.session_state.df_clean = df_clean\n")
    f.write("    \n")
    f.write("    # ============================================\n")
    ...
    f.write("                cluster_data = st.session_state.df_clean[st.session_state.df_clean['Cluster'] == cluster]\n")
    f.write("                \n")
    ...
    f.write("                    'Size': size,\n")
    f.write("                    'Percentage': str(round(size/len(st.session_state.df_clean)*100, 1)) + '%',\n")
    ...
    f.write("                \n")
    f.write("                size = len(cluster_data)\n")
    f.write("                percentage = (size / len(st.session_state.df_clean)) * 100\n")
    f.write("                age_mean = cluster_data['Age'].mean()\n")
    f.write("                income_mean = cluster_data['Annual_Income'].mean()\n")
    f.write("                spending_mean = cluster_data['Spending_Score'].mean()\n")
    f.write("                \n")
    ...
    f.write("            csv = st.session_state.df_clean.to_csv(index=False).encode('utf-8')\n")
