# Create streamlit_app.py - Fixed errors, slider limited to 5, keep your profiling
import os
...
with open('streamlit_app.py', 'w', encoding='utf-8') as f:
    ...
    f.write("            # Safely get silhouette scores\n")
    ...
    f.write("            if st.session_state.kmeans_sil is not None and st.session_state.dbscan_sil is not None:\n")
    ...
    f.write("            else:\n")
    f.write("                st.info('Compare the metrics above to determine the best algorithm.')\n")
    f.write("        else:\n")
    ...
    f.write("    \n")
    f.write("    # ============================================\n")
    f.write("    # CUSTOMER PROFILING PAGE (YOUR ORIGINAL CODE)\n")
    f.write("    # ============================================\n")
