# Create streamlit_app.py line by line - NO multi-line strings
import os
...
with open('streamlit_app.py', 'w', encoding='utf-8') as f:
    ...
    f.write("        \n")
    f.write("        with col2:\n")
    f.write("            if 'kmeans_labels' in st.session_state:\n")
    ...
    f.write("                    else:\n")
    f.write("                        st.warning('Found only ' + str(n_clusters) + ' clusters')\n")
    f.write("        \n")
    f.write("        with col2:\n")
    f.write("            if 'dbscan_labels' in st.session_state:\n")
    f.write("                m1, m2, m3 = st.columns(3)\n")
    ...
    f.write("        \n")
    f.write("        if 'kmeans_labels' in st.session_state and 'dbscan_labels' in st.session_state:\n")
    f.write("            comparison_data = {\n")
    f.write("                'Algorithm': ['K-Means', 'DBSCAN'],\n")
    f.write("                'Silhouette Score': [str(round(st.session_state.kmeans_sil, 4)), str(round(st.session_state.dbscan_sil, 4)) if 'dbscan_sil' in st.session_state else 'N/A'],\n")
